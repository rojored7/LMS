# HU-044: Peer Review de Proyectos
...
**Como** estudiante
**Quiero** revisar proyectos de otros estudiantes
**Para** aprender de mis pares

---

## Criterios de Aceptación

- [ ] **AC1:** Sistema de asignación aleatoria de revisiones
- [ ] **AC2:** Rúbricas para peer review
- [ ] **AC3:** Calificación combinada: instructor + peers
...
### Tests Unitarios
```typescript
describe('HU-044: Peer Review de Proyectos', () => {
...
```typescript
describe('[Peer Review de Proyectos] Integration Tests', () => {
...
- Backlog: `docs/backlog.md` - Sprint Backlog, HU-044
