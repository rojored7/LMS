/**
 * trainingProfile Controller Tests
 * Tests exhaustivos para el controlador de trainingprofile
 */
...
jest.mock('../../services/trainingProfile.service');
jest.mock('../../utils/prisma');
jest.mock('../../utils/redis');

describe('TrainingProfileController', () => {
  let controller: TrainingProfileController;
  let service: jest.Mocked<TrainingProfileService>;
  let req: Request;
  let res: Response;
  let next: NextFunction;

  beforeEach(() => {
    service = new TrainingProfileService() as jest.Mocked<TrainingProfileService>;
    controller = new TrainingProfileController();
    (controller as any).trainingProfileService = service;
