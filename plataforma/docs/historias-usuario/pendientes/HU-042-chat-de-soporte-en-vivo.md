# HU-042: Chat de Soporte en Vivo
...
**Como** estudiante
**Quiero** hacer preguntas en tiempo real a instructores
...
- [ ] **AC1:** Chat en tiempo real con websockets
- [ ] **AC2:** Notificaciones push
- [ ] **AC3:** Historial de conversaciones
...
### Tests Unitarios
```typescript
describe('HU-042: Chat de Soporte en Vivo', () => {
...
```typescript
describe('[Chat de Soporte en Vivo] Integration Tests', () => {
...
- Backlog: `docs/backlog.md` - Sprint Backlog, HU-042
