...
export const CourseDetail: React.FC = () => {
  ...
  const { data: modules, isLoading: isLoadingModules } = useCourseModules(id!);
            ...
            <CardBody>
              ...
              <div className="mb-6">
                ...
                {isLoadingModules ? (
                  ...
                  <p className="text-sm text-gray-500">No hay modulos disponibles aun.</p>
                )}
              </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {course.tags.map((tag, index) => (
                      <Badge
                        ...
                        variant="default"
                        size="sm"
                        className="bg-blue-50 text-[#166EB6]"
                      >
                        {tag}
                      </Badge>
                    ))}
          ...
          <Card className="sticky top-20">
            <CardBody>
              ...
              <div className="text-center mb-6">
                <p className="text-3xl font-bold text-[#FF5100]">
              ...
              {user?.role === UserRole.ADMIN ? (
                ...
                <Button
                  ...
                  size="lg"
                  className="w-full mb-4"
                  onClick={() => navigate(ROUTES.LOGIN, { state: { from: `/courses/${id}` } })}
                >
              ...
              <div className="space-y-4 pt-4 border-t border-gray-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{formatDate(course.updatedAt)}</p>
                </div>
              </div>
            </CardBody>
          </Card>
