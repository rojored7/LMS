 ...
 * Tests exhaustivos para el controlador de notification
 */
...
describe('NotificationController', () => {
  ...
  beforeEach(() => {
    service = new NotificationService() as jest.Mocked<NotificationService>;
    controller = new NotificationController();
    (controller as any).notificationService = service;
