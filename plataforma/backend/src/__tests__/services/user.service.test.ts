/**
 * user Service Tests
 * Tests exhaustivos para el servicio de user
 */
...
describe('UserService', () => {
  ...
  describe('getAll', () => {
    it('should return all items', async () => {
      ...
      prismaMock.user.findMany.mockResolvedValue(mockData as any);
  ...
  describe('getById', () => {
    it('should return item by id', async () => {
      ...
      prismaMock.user.findUnique.mockResolvedValue(mockItem as any);
  ...
  describe('update', () => {
    it('should update existing item', async () => {
      ...
      prismaMock.user.findUnique.mockResolvedValue({ id: 'test-id' } as any);
    ...
    it('should handle partial updates', async () => {
      ...
      prismaMock.user.findUnique.mockResolvedValue({ id: 'test-id' } as any);
      prismaMock.user.update.mockResolvedValue({ id: 'test-id', ...partialUpdate } as any);
  ...
  describe('delete', () => {
    it('should delete item', async () => {
      prismaMock.user.findUnique.mockResolvedValue({ id: 'test-id' } as any);
      prismaMock.user.delete.mockResolvedValue({ id: 'test-id' } as any);
  ...
  describe('caching', () => {
    ...
    it('should invalidate cache on update', async () => {
      ...
      prismaMock.user.findUnique.mockResolvedValue(mockItem as any);
      prismaMock.user.update.mockResolvedValue({ ...mockItem, name: 'Updated' } as any);

      await service.getById('test-id');
      await service.update('test-id', { name: 'Updated' });

      // Cache should be invalidated after update
      prismaMock.user.findUnique.mockResolvedValue({ ...mockItem, name: 'Updated' } as any);
      await service.getById('test-id');
  ...
  describe('error handling', () => {
    it('should handle network errors', async () => {
      prismaMock.user.findMany.mockRejectedValue(new Error('ECONNREFUSED'));

      await expect(service.getAll()).rejects.toThrow('Database connection failed');
    });

    it('should handle timeout errors', async () => {
      prismaMock.user.findMany.mockRejectedValue(new Error('Query timeout'));
