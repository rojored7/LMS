 ...
 * Tests exhaustivos para el controlador de certificate
 */
...
describe('CertificateController', () => {
  ...
  let service: jest.Mocked<CertificateService>;
  let req: Request;
  let res: Response;
  let next: NextFunction;

  beforeEach(() => {
    service = new CertificateService() as jest.Mocked<CertificateService>;
    controller = new CertificateController();
    (controller as any).certificateService = service;
